...
public class CreationCost
{
    ...
    public static readonly Cost GoldDeposit = new Cost(0, 100, 0, 0);
    public static readonly Cost Home = new Cost(100, 0, 0, 20);
    public static readonly Cost WoodDeposit = new Cost(0,50,0,0);
    public static readonly Cost StoneDeposit = new Cost(0, 100, 0, 0);
    public static readonly Cost WindMill = new Cost(0, 100, 0, 0);
